...
export const deleteTrigger = (
 ...
 options?: SecondParameter<typeof openfortApiClient<TriggerDeleteResponse>>,) => {
  ...
  /**
 * Re-enables a trigger that was automatically deactivated after repeated delivery failures.
 *
 * Webhook triggers are deactivated when consecutive deliveries fail; once the endpoint is
 * healthy again, use this to resume notifications. The failure counter is reset.
...
export const enableTrigger = (
 ...
 options?: SecondParameter<typeof openfortApiClient<TriggerResponse>>,) => {
      return openfortApiClient<TriggerResponse>(
      {url: `/v1/subscriptions/triggers/${triggerId}/enable`, method: 'POST'
    },
      options);
    }
  /**
...
export type EnableTriggerResult = NonNullable<Awaited<ReturnType<typeof enableTrigger>>>
