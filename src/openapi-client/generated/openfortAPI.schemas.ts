...
export interface CreateTransactionIntentRequest {
  ...
  policy?: string;
  /**
     * For a fee-sponsorship Policy that accepts several user-pay ERC-20 tokens, the on-chain
...
export const APITopic = {
  ...
  fundingsessionupdated: 'funding.session.updated',
} as const;
...
export interface TriggerResponse {
  ...
  subscription: string;
  /**
     * Whether the trigger is active. Webhook triggers are automatically
...
export interface SolanaTransactionStatusResponse {
  ...
  /**
     * Jito bundle UUID for `signAndSendBundle` transactions; null otherwise.
     * A submission handle — status is resolved via the first child signature.
     * @nullable
     */
  bundleId: string | null;
  /**
     * All child signatures of a Jito bundle, in order. Empty for single-tx rows.
...
export interface OnrampQuoteRequest {
  ...
  sourceAmount: string;
  /**
     * Where the funds would land. Optional because a quote doesn't move money,
...
export interface MePermissionsResponse {
  /** True when the authenticated user is an Openfort staff member. */
  isStaff: boolean;
}
...
export type TransactionStatusV2 = typeof TransactionStatusV2[keyof typeof TransactionStatusV2];


export const TransactionStatusV2 = {
...
export interface FeeSponsorshipStrategyResponse {
  ...
  tokenContractAmount?: string;
  /**
     * Whether any accepted token is priced dynamically from cached prices.
  ...
  splTokens?: string[];
  /**
     * ERC-20 tokens accepted as user-pay fee for EVM charge_custom_tokens policies.
     ...
     */
  tokenContracts?: EvmTokenContractEntryResponse[];
}
...
export const UserOperationExecutionType = {
 ...
 */
export type UserOperationExecutionEntryPointVersion = typeof UserOperationExecutionEntryPointVersion[keyof typeof UserOperationExecutionEntryPointVersion];


export const UserOperationExecutionEntryPointVersion = {
  '06': '0.6',
  '08': '0.8',
  '09': '0.9',
} as const;
...
export interface UserOperationExecution {
  type: UserOperationExecutionType;
  /** ERC-4337 EntryPoint version the user operation targets. */
  entryPointVersion: UserOperationExecutionEntryPointVersion;
  userOperationHash: string;
  /** The full user operation. Present only with `expand=userOperation`. */
  userOperation?: UserOperationV6 | UserOperationV8 | UserOperationV9;
}

export type TransactionExecutionType = typeof TransactionExecutionType[keyof typeof TransactionExecutionType];
...
export type SignHashActionType = typeof SignHashActionType[keyof typeof SignHashActionType];


export const SignHashActionType = {
  sign_hash: 'sign_hash',
} as const;

export interface SignHashAction {
  type: SignHashActionType;
...
/**
 * Timeline events: every `TransactionStatusV2` value (a state change), plus monitoring-only events that
...
export interface TransactionTimelineEntryV2 {
  ...
  /**
     * Unix timestamp (seconds). Absent when the exact time is unknown (e.g. `submitted` for a
     * transaction the monitor did not track).
     */
  at?: number;
}

export type EntityTypeTRANSACTION = typeof EntityTypeTRANSACTION[keyof typeof EntityTypeTRANSACTION];


export const EntityTypeTRANSACTION = {
  transaction: 'transaction',
} as const;
...
export interface TransactionResponseV2 {
  ...
  /** Present while `status` is `awaiting_signature`. */
  nextAction?: SignHashAction;
  /** Present once the transaction reached a terminal status. */
  receipt?: TransactionReceiptV2;
  /**
     * Lifecycle history in order, present only with `expand=timeline`. Status-valued events come from
     ...
     */
  timeline?: TransactionTimelineEntryV2[];
  /** The actual transaction cost in USD, available after on-chain confirmation. */
  costUsd?: string;
}
...
export interface TransactionListQueriesV2 {
  ...
  order?: PrismaSortOrder;
  /**
     * Specifies the fields to expand in the response. `timeline` adds the lifecycle history (one
     ...
     */
  expand?: TransactionExpandableV2[];
  /** The chain ID. Must be a [supported chain](/development/chains). */
  chainId?: number;
...
export type PolicyV2ListQueriesScopeItem = typeof PolicyV2ListQueriesScopeItem[keyof typeof PolicyV2ListQueriesScopeItem];


export const PolicyV2ListQueriesScopeItem = {
  project: 'project',
  account: 'account',
  transaction: 'transaction',
} as const;
 ...
 * @nullable
 */
export type OnrampIdentityResponseRegion = typeof OnrampIdentityResponseRegion[keyof typeof OnrampIdentityResponseRegion] | null;


export const OnrampIdentityResponseRegion = {
  us: 'us',
  eu: 'eu',
} as const;
 ...
 */
export type OnrampIdentityResponseLevel = typeof OnrampIdentityResponseLevel[keyof typeof OnrampIdentityResponseLevel];


export const OnrampIdentityResponseLevel = {
  L0: 'L0',
  L1: 'L1',
  L2: 'L2',
  PENDING: 'PENDING',
...
export interface OnrampIdentityResponse {
  /**
     ...
     * @nullable
     */
  region: OnrampIdentityResponseRegion;
  /** Verification tier reached; anything but L0/L1/L2 means more is needed. */
  level: OnrampIdentityResponseLevel;
  providedFields: string[];
}

export type OnrampLimitUpgradeStatusResponseStatus = typeof OnrampLimitUpgradeStatusResponseStatus[keyof typeof OnrampLimitUpgradeStatusResponseStatus];


export const OnrampLimitUpgradeStatusResponseStatus = {
...
export interface OnrampLimitUpgradeStatusResponse {
  status: OnrampLimitUpgradeStatusResponseStatus;
  /** False once the provider has stopped offering the upgrade at all. */
  available: boolean;
}

/**
 * The buyer's current transaction limits, as the provider shapes them.
...
/**
 * One resolved funding method the SDK/widget renders. The provider is included
...
export interface ResolvedFundingMethodResponse {
  ...
  rail?: string;
  /**
     * Provider PUBLISHABLE key for "embedded" rows — the client's pre-commit
...
export interface OnrampMethodsResponse {
  /**
     ...
     */
  country: string | null;
  methods: ResolvedFundingMethodResponse[];
}
...
export interface FundingChainResponse {
  ...
  /** "evm" | "svm". */
  vmType: string;
  currencies: FundingChainCurrencyResponse[];
}

/**
 * Source chains + currencies the rail supports (a live passthrough of Relay's dictionary).
 */
export interface FundingChainsResponse {
  chains: FundingChainResponse[];
}
 ...
 */
export interface FundingMetadata {[key: string]: string}
...
export interface FundingCryptoPaymentMethodResponse {
  ...
  deeplinks: FundingWalletDeeplinkResponse[];
  fees: FundingFeeResponse[];
  /**
...
export type FundingOnrampPaymentMethodResponseType = typeof FundingOnrampPaymentMethodResponseType[keyof typeof FundingOnrampPaymentMethodResponseType];


export const FundingOnrampPaymentMethodResponseType = {
  onramp: 'onramp',
} as const;

/**
 * The resolved fiat onramp payment method. The executing provider is resolved
...
export interface FundingOnrampPaymentMethodResponse {
  type: FundingOnrampPaymentMethodResponseType;
  ...
  url: string | null;
  /**
     * The provider's own session/order id for this commit (for embedded rows,
 ...
 */
export type FundingPaymentMethodResponse = FundingCryptoPaymentMethodResponse | FundingOnrampPaymentMethodResponse;

export type EntityTypeFUNDINGSESSION = typeof EntityTypeFUNDINGSESSION[keyof typeof EntityTypeFUNDINGSESSION];


export const EntityTypeFUNDINGSESSION = {
  fundingSession: 'fundingSession',
} as const;
 ...
 */
export type CryptoPaymentMethodRequestType = typeof CryptoPaymentMethodRequestType[keyof typeof CryptoPaymentMethodRequestType];


export const CryptoPaymentMethodRequestType = {
  evm: 'evm',
  solana: 'solana',
} as const;
...
export interface CryptoPaymentMethodRequest {
  /** Self-custody source family. */
  type: CryptoPaymentMethodRequestType;
  source: FundingSourceRequest;
  /**
     * Origin-chain address refunded if the deposit bounces. Defaults to the
     * target address (valid for same-address EVM embedded wallets).
     */
  refundTo?: string;
}

export type OnrampPaymentMethodRequestType = typeof OnrampPaymentMethodRequestType[keyof typeof OnrampPaymentMethodRequestType];


export const OnrampPaymentMethodRequestType = {
  onramp: 'onramp',
} as const;
 ...
 */
export type OnrampPaymentMethodRequestMethod = typeof OnrampPaymentMethodRequestMethod[keyof typeof OnrampPaymentMethodRequestMethod];


export const OnrampPaymentMethodRequestMethod = {
  apple_pay: 'apple_pay',
...
export type OnrampPaymentMethodRequestAnglesItem = typeof OnrampPaymentMethodRequestAnglesItem[keyof typeof OnrampPaymentMethodRequestAnglesItem];


export const OnrampPaymentMethodRequestAnglesItem = {
  popup: 'popup',
  native: 'native',
  embedded: 'embedded',
} as const;
 ...
 */
export type OnrampPaymentMethodRequestEmbedded = {
...
/**
 * A fiat web2 onramp payment method. The provider is auto-selected server-side
...
export interface OnrampPaymentMethodRequest {
  type: OnrampPaymentMethodRequestType;
  /** The funding method the user picked. */
  method: OnrampPaymentMethodRequestMethod;
  /**
     * Fiat amount to prefill in the provider checkout, in the source currency's
  ...
  sourceCurrency?: string;
  /**
     * Explicit buyer country override (ISO-3166 alpha-2). Wins over the request
  ...
  redirectUrl?: string;
  /**
     * Integration angles the client can execute; omit for no restriction. A
     ...
     */
  angles?: OnrampPaymentMethodRequestAnglesItem[];
  /**
     * Origin-chain refund address for an auto-bridged (chained) route — where the
  ...
  refundTo?: string;
  /**
     * OTP-verified buyer email — REQUIRED for `apple_pay`/`google_pay` (the
  ...
  /**
     * ISO-8601 time the buyer accepted the checkout terms surfaced at the
     * amount step. REQUIRED for `apple_pay`/`google_pay`.
     */
  agreementAcceptedAt?: string;
  /**
     * Verification record for the phone, from
     * POST /v2/funding/onramp/verifications (channel "sms") + submit.
     */
  smsVerificationId?: string;
  /**
     * Verification record for the email, from
 ...
 */
export type PaymentMethodRequest = CryptoPaymentMethodRequest | OnrampPaymentMethodRequest;
...
export interface CreateFundingSessionRequest {
  ...
  /**
     * Lock the deposit to a fixed amount (destination base units). Omit to let
     * the sender choose any amount above the route minimum.
     */
  amountUnits?: string;
  /** Arbitrary string metadata stored with the session. */
  metadata?: FundingMetadata;
  /**
     * Idempotency/correlation key. Reusing the same value returns the existing
     * session instead of creating a new one.
     */
  externalId?: string;
  /**
     * Deposit-address mode. `true` mints a single-use address bound to one
     * deposit; `false` (default) mints an open address reusable for the route.
     */
  strict?: boolean;
  /**
     * Set the payment method in the same call when the source route is already
 ...
 */
export type SessionQuoteRequestMethod = typeof SessionQuoteRequestMethod[keyof typeof SessionQuoteRequestMethod];


export const SessionQuoteRequestMethod = {
  apple_pay: 'apple_pay',
  google_pay: 'google_pay',
  card: 'card',
  bank_transfer: 'bank_transfer',
...
export type SessionQuoteRequestAnglesItem = typeof SessionQuoteRequestAnglesItem[keyof typeof SessionQuoteRequestAnglesItem];


export const SessionQuoteRequestAnglesItem = {
  popup: 'popup',
  native: 'native',
  embedded: 'embedded',
} as const;
...
/**
 * Price a fiat onramp route for a session before committing it. The provider is
...
export interface SessionQuoteRequest {
  ...
  clientSecret: string;
  /** The funding method to price. */
  method: SessionQuoteRequestMethod;
  ...
  country?: string;
  /**
     * Integration angles the client can execute; omit for no restriction. Must
     * match the `angles` the commit will send so the quoted provider is the one
     * that executes.
     */
  angles?: SessionQuoteRequestAnglesItem[];
}
...
/**
 * Build a prefilled centralized-exchange (cex) transfer link for a session.
 *
...
export interface PayLinkRequest {
  ...
  clientSecret: string;
  /**
     * Amount to deliver, in the asset's human units. Minimum 5 (the cex
     * provider's minimum, enforced server-side).
     */
  amount: string;
  /**
     * Asset ticker to deliver, as the exchange labels it. Must be supported by
...
export interface PickFundingProjectConfigExcludeKeyofFundingProjectConfigCredentials {
  ...
  /**
     * The project's Stripe publishable key, handed to the client so the embedded
...
/**
 * GET/PUT /v2/funding/config response — the project funding config with the
...
export interface FundingConfigResponse {
  ...
  /**
     * The project's Stripe secret key AND Link OAuth client are set — the
...
/**
 * The developer's provider credentials for the in-page rails. Every field is
...
export interface UpdateFundingConfigRequest {
  ...
  /**
     * Follows the credential rules, since it belongs to the same Stripe account:
...
/**
 * A single ERC-20 token entry in a multi-token EVM gas-sponsorship policy.
 */
export interface EvmTokenContractEntry {
  /** Token contract UUID. */
  contract: string;
  /** Static exchange rate (wei-denominated). Omit to use the dynamic cached rate. */
  amount?: string;
}
...
export interface FeeSponsorshipStrategy {
  ...
  /**
     ...
     * and with splTokens.
     */
  tokenContracts?: EvmTokenContractEntry[];
  /**
...
/**
 * Present when the project is scheduled for deletion due to inactivity.
 ...
 */
export type ProjectResponseScheduledDeletion = {
...
export interface ProjectResponse {
  ...
  isActive: boolean;
  /**
     * "Permanent" marker: the project is exempt from the automatic inactivity
...
export interface DeletionProtectionRequest {
  /**
     * true marks the project "permanent" (exempt from the automatic inactivity
     * deletion sweep); false removes the exemption.
     */
  protected: boolean;
}

export type EntityTypePROJECTDELETION = typeof EntityTypePROJECTDELETION[keyof typeof EntityTypePROJECTDELETION];


export const EntityTypePROJECTDELETION = {
  projectdeletion: 'project.deletion',
} as const;

/**
 * Deletion state. Access is cut immediately; the purge itself runs
 * asynchronously.
 */
export type ProjectDeletionResponseStatus = typeof ProjectDeletionResponseStatus[keyof typeof ProjectDeletionResponseStatus];


export const ProjectDeletionResponseStatus = {
  pending: 'pending',
} as const;
...
export interface ProjectDeletionResponse {
  ...
  /**
     ...
     * asynchronously.
     */
  status: ProjectDeletionResponseStatus;
}

export interface DeleteProjectRequest {
  /**
     * The exact name of the project, typed as confirmation. Deletion is
...
export type GetGasPolicyRulesLegacyParams = {
/**
 * Specifies the maximum number of records to return.
 * @minimum 1
 */
...
export type GetGasPolicyRulesLegacyExpandItem = typeof GetGasPolicyRulesLegacyExpandItem[keyof typeof GetGasPolicyRulesLegacyExpandItem];


export const GetGasPolicyRulesLegacyExpandItem = {
  contract: 'contract',
} as const;

export type GetGasPoliciesLegacyParams = {
/**
 * Specifies the maximum number of records to return.
 * @minimum 1
 */
...
export type GetGasPolicyLegacyParams = {
/**
 * Specifies the fields to expand.
 */
expand?: PolicyResponseExpandable[];
...
export type GetGasPolicyTotalGasUsageLegacyParams = {
/**
 * Specifies the maximum number of records to return.
 * @minimum 1
 */
...
export type GetGasPolicyReportTransactionIntentsLegacyParams = {
/**
 * The start date of the period in unix timestamp.
 */
to: number;
...
export type GetTransactionV2Params = {
/**
 * Specifies the expandable fields.
 */
expand?: TransactionExpandableV2[];
...
export const ListPoliciesScopeItem = {
  project: 'project',
  account: 'account',
  transaction: 'transaction',
} as const;

export type CreateOnrampVerificationBodyChannel = typeof CreateOnrampVerificationBodyChannel[keyof typeof CreateOnrampVerificationBodyChannel];


export const CreateOnrampVerificationBodyChannel = {
  sms: 'sms',
  email: 'email',
} as const;

export type CreateOnrampVerificationBody = {
  destination: string;
  channel: CreateOnrampVerificationBodyChannel;
};

export type SubmitOnrampVerificationBody = {
  otpCode: string;
};

export type CreateOnrampAuthIntentBody = {
  email: string;
};

export type GetOnrampIdentityParams = {
authIntentId: string;
customerRef: string;
};

export type GetOnrampLimitsParams = {
authIntentId?: string;
phoneNumber?: string;
method?: GetOnrampLimitsMethod;
walletAddress?: string;
network?: string;
};

export type GetOnrampLimitsMethod = typeof GetOnrampLimitsMethod[keyof typeof GetOnrampLimitsMethod];


export const GetOnrampLimitsMethod = {
  apple_pay: 'apple_pay',
  google_pay: 'google_pay',
} as const;

export type StartOnrampLimitUpgradeBodyMethod = typeof StartOnrampLimitUpgradeBodyMethod[keyof typeof StartOnrampLimitUpgradeBodyMethod];


export const StartOnrampLimitUpgradeBodyMethod = {
  apple_pay: 'apple_pay',
  google_pay: 'google_pay',
} as const;

export type StartOnrampLimitUpgradeBody = {
  method: StartOnrampLimitUpgradeBodyMethod;
  phoneNumber: string;
};

export type GetFundingOnrampMethodsParams = {
targetChain: string;
...
/**
 * Live (mainnet, default) or test (testnet) rail. Pass `false`
 * from a test-mode (`pk_test_…`) client so the testnet chain list is returned.
 */
livemode?: boolean;
};

export type CheckoutFundingOnrampSessionBody = {
  clientSecret: string;
};

export type CheckoutFundingOnrampSession200 = {
  clientSecret: string;
};

export type GetFundingSessionMethodsParams = {
/**
 * The session client secret returned at creation.
 * Deliberately a query parameter (GET semantics): the secret is
 * short-lived and session-scoped; every other endpoint takes it in the
 * POST body.
 */
clientSecret?: string;
/**
 * Explicit buyer-country override (ISO-3166 alpha-2); defaults
 * to the request IP's country.
 */
country?: string;
/**
 * Comma-separated integration angles the client can execute
 * (e.g. "popup" from React Native); omit for no restriction.
 */
angles?: string;
};

export type GetFundingSessionParams = {
/**
 * The session client secret returned at creation.
 */
clientSecret?: string;
...
export type ListFeeSponsorshipsParams = {
/**
 * Specifies the maximum number of records to return.
 * @minimum 1
 */
