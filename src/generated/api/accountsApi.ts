...
export class AccountsApi {
    ...
    public async getAccount(
        ...
        const localVarPath =
            this.basePath + "/v1/accounts/{id}".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async getAccountInventory(
        ...
        const localVarPath =
            this.basePath + "/v1/accounts/{id}/inventory".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async signPayload(
        ...
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: SignPayloadResponse }> {
        const localVarPath =
            this.basePath + "/v1/accounts/{id}/sign-payload".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async transferOwnership(
        ...
        if (transferOwnershipRequest === null || transferOwnershipRequest === undefined) {
            throw new Error(
                "Required parameter transferOwnershipRequest was null or undefined when calling transferOwnership.",
            );
        }
