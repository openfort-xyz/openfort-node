...
import { SignTextRequest } from '../model/signTextRequest';
import { SignTextResponse } from '../model/signTextResponse';
...
export class AccountsApi {
     ...
     * Sign a given text
     * @param id Specifies the unique account ID.
     * @param signTextRequest 
     */
    public async signText (id: string, signTextRequest: SignTextRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SignTextResponse;  }> {
        const localVarPath = this.basePath + '/v1/accounts/{id}/sign-text'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling signText.');
        }

        // verify required parameter 'signTextRequest' is not null or undefined
        if (signTextRequest === null || signTextRequest === undefined) {
            throw new Error('Required parameter signTextRequest was null or undefined when calling signText.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(signTextRequest, "SignTextRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SignTextResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "SignTextResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
