...
export class PoliciesApi {
    ...
    public async createPolicyAllowFunction(
        ...
        const localVarPath =
            this.basePath + "/v1/policies/{id}/policy_rules".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
        ...
        if (createPolicyAllowFunctionRequest === null || createPolicyAllowFunctionRequest === undefined) {
            throw new Error(
                "Required parameter createPolicyAllowFunctionRequest was null or undefined when calling createPolicyAllowFunction.",
            );
        }
    ...
    public async deletePolicy(
        ...
        const localVarPath =
            this.basePath + "/v1/policies/{id}".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async getPolicyTotalGasUsage(
        id: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: GasReport }> {
        const localVarPath =
            this.basePath + "/v1/policies/{id}/reports".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async updatePolicyAllowFunction(
        ...
        if (updatePolicyRuleRequest === null || updatePolicyRuleRequest === undefined) {
            throw new Error(
                "Required parameter updatePolicyRuleRequest was null or undefined when calling updatePolicyAllowFunction.",
            );
        }
