...
export class TransactionIntentsApi {
    ...
    public async createTransactionIntent(
    ...
    ): Promise<{ response: http.IncomingMessage; body: TransactionIntentResponse }> {
        ...
        if (createTransactionIntentRequest === null || createTransactionIntentRequest === undefined) {
            throw new Error(
                "Required parameter createTransactionIntentRequest was null or undefined when calling createTransactionIntent.",
            );
        }
    ...
    public async getTransactionIntent(
        ...
        const localVarPath =
            this.basePath + "/v1/transaction_intents/{id}".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async getTransactionIntents(
        ...
        skip?: number,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: TransactionIntentsResponse }> {
        const localVarPath = this.basePath + "/v1/transaction_intents";
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        ...
        if (expand !== undefined) {
            localVarQueryParameters["expand"] = ObjectSerializer.serialize(
                expand,
                "Array<'nextAction' | 'policy' | 'player' | 'account'>",
            );
        }
    ...
    public async signature(
        ...
        const localVarPath =
            this.basePath +
            "/v1/transaction_intents/{id}/signature".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async updateTransactionIntentResponse(
        ...
        const localVarPath =
            this.basePath +
            "/v1/transaction_intents/{id}/update_response".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
