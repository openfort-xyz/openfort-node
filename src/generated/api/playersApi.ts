...
export class PlayersApi {
    ...
    public async createPlayerAccount(
        ...
        const localVarPath =
            this.basePath + "/v1/players/{id}/accounts".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
        ...
        if (createPlayerAccountRequest === null || createPlayerAccountRequest === undefined) {
            throw new Error(
                "Required parameter createPlayerAccountRequest was null or undefined when calling createPlayerAccount.",
            );
        }
    ...
    public async createPlayerSession(
        ...
        const localVarPath =
            this.basePath + "/v1/players/{id}/sessions".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async getPlayer(
        ...
        const localVarPath =
            this.basePath + "/v1/players/{id}".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async getPlayerInventory(
        ...
        const localVarPath =
            this.basePath + "/v1/players/{id}/inventory".replace("{" + "id" + "}", encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ["application/json"];
        // give precedence to 'application/json'
    ...
    public async revokePlayerSession(
        ...
        if (revokeSessionPlayerRequest === null || revokeSessionPlayerRequest === undefined) {
            throw new Error(
                "Required parameter revokeSessionPlayerRequest was null or undefined when calling revokePlayerSession.",
            );
        }
    ...
    public async transferAccountOwnership(
        ...
        if (playerTransferOwnershipRequest === null || playerTransferOwnershipRequest === undefined) {
            throw new Error(
                "Required parameter playerTransferOwnershipRequest was null or undefined when calling transferAccountOwnership.",
            );
        }
