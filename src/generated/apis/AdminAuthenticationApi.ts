...
export class AdminAuthenticationApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async authorize(
    ...
    if (
      authorizePlayerRequest === null ||
      authorizePlayerRequest === undefined
    ) {
  ...
  public async createAuthPlayer(
    ...
    if (
      createAuthPlayerRequest === null ||
      createAuthPlayerRequest === undefined
    ) {
      throw new RequiredError(
        'AdminAuthenticationApi',
        'createAuthPlayer',
   ...
   * @param body Specifies the oauth provider specific configuration.
   */
  public async createOAuthConfig(
    body: AuthConfig,
    _options?: Configuration,
  ): Promise<RequestContext> {
    const _config = _options || this.configuration
  ...
  public async deleteAuthPlayer(
    ...
    // Path Params
    const localVarPath = '/iam/v1/players/{id}'.replace(
      '{' + 'id' + '}',
   ...
   */
  public async deleteOAuthConfig(
    ...
    // Path Params
    const localVarPath = '/iam/v1/oauth/{provider}'.replace(
      '{' + 'provider' + '}',
  ...
  public async getAuthPlayer(
    ...
    // verify required parameter 'id' is not null or undefined
    if (id === null || id === undefined) {
      throw new RequiredError('AdminAuthenticationApi', 'getAuthPlayer', 'id')
    }
  ...
  public async getAuthPlayers(
    ...
    if (email !== undefined) {
      requestContext.setQueryParam(
        'email',
        ObjectSerializer.serialize(email, 'string', ''),
      )
    }
    ...
    if (externalUserId !== undefined) {
      requestContext.setQueryParam(
        'externalUserId',
        ObjectSerializer.serialize(externalUserId, 'string', ''),
      )
    }
...
export class AdminAuthenticationApiResponseProcessor {
  ...
  public async createAuthPlayer(
    ...
    if (isCodeInRange('200', response.httpStatusCode)) {
      const body: AuthPlayerResponseWithRecoveryShare =
   ...
   * to the expected objects
   *
   * @params response Response returned by the server for a request to getAuthPlayer
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async getAuthPlayer(
    response: ResponseContext,
