...
export class OAuthApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async auth(provider: OAuthProvider, oAuthRequest: OAuthRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'provider' is not null or undefined
        if (provider === null || provider === undefined) {
            throw new RequiredError("OAuthApi", "auth", "provider");
        }


        // verify required parameter 'oAuthRequest' is not null or undefined
        if (oAuthRequest === null || oAuthRequest === undefined) {
            throw new RequiredError("OAuthApi", "auth", "oAuthRequest");
        }
...
export class OAuthApiResponseProcessor {
     ...
     */
     public async auth(response: ResponseContext): Promise<AuthResponse > {
