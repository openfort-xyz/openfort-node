...
export class PaymasterApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createPaymaster(createPaymasterRequest: CreatePaymasterRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (createPaymasterRequest === null || createPaymasterRequest === undefined) {
            throw new RequiredError("PaymasterApi", "createPaymaster", "createPaymasterRequest");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createPaymasterRequest, "CreatePaymasterRequest", ""),
            contentType
        );
     ...
     * @param id 
     */
    public async deletePaymaster(id: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param id 
     */
    public async getPaymaster(id: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async listPaymasters(limit?: number, skip?: number, order?: SortOrder, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param createPaymasterRequest 
     */
    public async updatePaymaster(id: string, createPaymasterRequest: CreatePaymasterRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'createPaymasterRequest' is not null or undefined
        if (createPaymasterRequest === null || createPaymasterRequest === undefined) {
            throw new RequiredError("PaymasterApi", "updatePaymaster", "createPaymasterRequest");
        }
...
export class PaymasterApiResponseProcessor {
     ...
     */
     public async createPaymaster(response: ResponseContext): Promise<PaymasterResponse > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deletePaymaster(response: ResponseContext): Promise<PaymasterDeleteResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getPaymaster(response: ResponseContext): Promise<PaymasterResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listPaymasters(response: ResponseContext): Promise<Array<PaymasterResponse> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<PaymasterResponse> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "Array<PaymasterResponse>", ""
            ) as Array<PaymasterResponse>;
            return body;
        }
        if (isCodeInRange("401", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "Error response.", undefined, response.headers);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updatePaymaster(response: ResponseContext): Promise<PaymasterResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: PaymasterResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
