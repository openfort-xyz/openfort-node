...
export class ContractsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async deleteContract(
    ...
    // Path Params
    const localVarPath = '/v1/contracts/{id}'.replace(
      '{' + 'id' + '}',
  ...
  public async readContract(
    ...
    // Path Params
    const localVarPath = '/v1/contracts/{id}/read'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
    ...
    if (functionName !== undefined) {
      requestContext.setQueryParam(
        'functionName',
        ObjectSerializer.serialize(functionName, 'string', ''),
      )
    }
    ...
    if (functionArgs !== undefined) {
      requestContext.setQueryParam(
        'functionArgs',
        ObjectSerializer.serialize(functionArgs, 'Array<any>', ''),
      )
    }
