...
export class GraphQLApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param body 
     */
    public async query(body: any, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("GraphQLApi", "query", "body");
        }
...
export class GraphQLApiResponseProcessor {
     ...
     */
     public async query(response: ResponseContext): Promise<any > {
