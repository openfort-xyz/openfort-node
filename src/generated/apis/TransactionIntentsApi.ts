...
import type { InvalidRequestErrorResponse } from '../models/InvalidRequestErrorResponse'
...
export class TransactionIntentsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createTransactionIntent(
    ...
    if (
      createTransactionIntentRequest === null ||
      createTransactionIntentRequest === undefined
    ) {
    ...
    requestContext.setHeaderParam(
      'X-Behalf-Of-Project',
      ObjectSerializer.serialize(xBehalfOfProject, 'string', ''),
    )
   ...
   * @param createTransactionIntentRequest
   */
  public async estimateTransactionIntentCost(
    createTransactionIntentRequest: CreateTransactionIntentRequest,
    _options?: Configuration,
  ): Promise<RequestContext> {
    const _config = _options || this.configuration
   ...
   */
  public async getTransactionIntent(
    id: string,
    ...
    // Path Params
    const localVarPath = '/v1/transaction_intents/{id}'.replace(
      '{' + 'id' + '}',
    ...
    if (expand !== undefined) {
      requestContext.setQueryParam(
        ...
        ObjectSerializer.serialize(
          expand,
          'Array<TransactionIntentResponseExpandable>',
          '',
        ),
      )
    }
  ...
  public async getTransactionIntents(
    ...
    if (account !== undefined) {
      requestContext.setQueryParam(
        'account',
        ObjectSerializer.serialize(account, 'Array<string>', ''),
      )
    }
    ...
    if (player !== undefined) {
      requestContext.setQueryParam(
        'player',
        ObjectSerializer.serialize(player, 'Array<string>', ''),
      )
    }
    ...
    if (status !== undefined) {
      requestContext.setQueryParam(
        'status',
        ObjectSerializer.serialize(status, 'number', 'double'),
      )
    }
    ...
    if (policy !== undefined) {
      requestContext.setQueryParam(
        'policy',
        ObjectSerializer.serialize(policy, 'Array<string>', ''),
      )
    }
  ...
  public async signature(
    ...
    // Path Params
    const localVarPath = '/v1/transaction_intents/{id}/signature'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
...
export class TransactionIntentsApiResponseProcessor {
  ...
  public async createTransactionIntent(
    ...
    if (isCodeInRange('400', response.httpStatusCode)) {
      ...
      throw new ApiException<InvalidRequestErrorResponse>(
  ...
  public async estimateTransactionIntentCost(
    ...
    if (isCodeInRange('200', response.httpStatusCode)) {
      const body: EstimateTransactionIntentGasResult =
