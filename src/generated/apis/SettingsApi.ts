...
export class SettingsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createDeveloperAccount(
    ...
    if (
      createDeveloperAccountCreateRequest === null ||
      createDeveloperAccountCreateRequest === undefined
    ) {
  ...
  public async deleteDeveloperAccount(
    ...
    // Path Params
    const localVarPath = '/v1/settings/developer_accounts/{id}'.replace(
      '{' + 'id' + '}',
  ...
  public async getDeveloperAccount(
    ...
    if (expand !== undefined) {
      requestContext.setQueryParam(
        ...
        ObjectSerializer.serialize(
          expand,
          'Array<DeveloperAccountResponseExpandable>',
          '',
        ),
      )
    }
   ...
   */
  public async getDeveloperAccounts(
    limit?: number,
    skip?: number,
    order?: SortOrder,
    expand?: DeveloperAccountResponseExpandable[],
   ...
   */
  public async getVerificationPayload(
    address: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    const _config = _options || this.configuration
   ...
   */
  public async signPayloadDeveloperAccount(
    id: string,
    ...
    // Path Params
    const localVarPath =
      '/v1/settings/developer_accounts/{id}/sign_payload'.replace(
        '{' + 'id' + '}',
        encodeURIComponent(String(id)),
      )
   ...
   */
  public async updateDeveloperAccount(
    id: string,
    ...
    if (
      updateDeveloperAccountCreateRequest === null ||
      updateDeveloperAccountCreateRequest === undefined
    ) {
      throw new RequiredError(
        'SettingsApi',
...
export class SettingsApiResponseProcessor {
  ...
  public async getVerificationPayload(
    ...
    if (isCodeInRange('200', response.httpStatusCode)) {
      const body: DeveloperAccountGetMessageResponse =
