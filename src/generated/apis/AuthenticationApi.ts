...
export class AuthenticationApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param xGame 
     */
    public async initOAuth(oAuthInitRequest: OAuthInitRequest, xGame?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param xGame 
     */
    public async initSIWE(sIWERequest: SIWERequest, xGame?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param xGame 
     */
    public async linkEmail(loginRequest: LoginRequest, xGame?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param xGame 
     */
    public async linkOAuth(oAuthInitRequest: OAuthInitRequest, xGame?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param xGame 
     */
    public async loginEmailPassword(loginRequest: LoginRequest, xGame?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param xGame 
     */
    public async loginOIDC(loginOIDCRequest: LoginOIDCRequest, xGame?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'loginOIDCRequest' is not null or undefined
        if (loginOIDCRequest === null || loginOIDCRequest === undefined) {
            throw new RequiredError("AuthenticationApi", "loginOIDC", "loginOIDCRequest");
        }
     ...
     */
    public async loginWithIdToken(loginWithIdTokenRequest: LoginWithIdTokenRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (loginWithIdTokenRequest === null || loginWithIdTokenRequest === undefined) {
            throw new RequiredError("AuthenticationApi", "loginWithIdToken", "loginWithIdTokenRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(loginWithIdTokenRequest, "LoginWithIdTokenRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
     ...
     * @param xGame 
     */
    public async signupEmailPassword(signupRequest: SignupRequest, xGame?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param xGame 
     */
    public async thirdParty(thirdPartyOAuthRequest: ThirdPartyOAuthRequest, xGame?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class AuthenticationApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async linkEmail(response: ResponseContext): Promise<LinkEmail200Response > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async loginEmailPassword(response: ResponseContext): Promise<SignupEmailPassword201Response > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async loginWithIdToken(response: ResponseContext): Promise<AuthResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: AuthResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async signupEmailPassword(response: ResponseContext): Promise<SignupEmailPassword201Response > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            const body: SignupEmailPassword201Response = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
