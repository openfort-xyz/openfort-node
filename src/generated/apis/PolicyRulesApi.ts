...
export class PolicyRulesApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async createPolicyRule(
    ...
    if (
      createPolicyRuleRequest === null ||
      createPolicyRuleRequest === undefined
    ) {
  ...
  public async deletePolicyRule(
    ...
    // Path Params
    const localVarPath = '/v1/policy_rules/{id}'.replace(
      '{' + 'id' + '}',
  ...
  public async getPolicyRules(
    ...
    if (expand !== undefined) {
      requestContext.setQueryParam(
        'expand',
        ObjectSerializer.serialize(expand, "Array<'contract'>", ''),
      )
    }
    ...
    if (policy !== undefined) {
      requestContext.setQueryParam(
        'policy',
        ObjectSerializer.serialize(policy, 'string', ''),
      )
    }
  ...
  public async updatePolicyRule(
    ...
    if (
      updatePolicyRuleRequest === null ||
      updatePolicyRuleRequest === undefined
    ) {
      throw new RequiredError(
        'PolicyRulesApi',
        'updatePolicyRule',
