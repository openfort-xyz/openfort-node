...
export class AccountsApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async cancelTransferOwnership(
    ...
    if (
      cancelTransferOwnershipRequest === null ||
      cancelTransferOwnershipRequest === undefined
    ) {
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}/cancel_transfer_ownership'.replace(
      '{' + 'id' + '}',
  ...
  public async completeRecovery(
    ...
    if (
      completeRecoveryRequest === null ||
      completeRecoveryRequest === undefined
    ) {
      throw new RequiredError(
        'AccountsApi',
        'completeRecovery',
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}/complete_recovery'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
  ...
  public async deployAccount(
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}/deploy'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
  ...
  public async disableAccount(
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}/disable'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
  ...
  public async getAccount(
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
    ...
    if (expand !== undefined) {
      requestContext.setQueryParam(
        ...
        ObjectSerializer.serialize(
          expand,
          'Array<AccountResponseExpandable>',
          '',
        ),
      )
    }
  ...
  public async getAccountV2(
    ...
    // Path Params
    const localVarPath = '/v2/accounts/{id}'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
  ...
  public async getAccounts(
    ...
    if (player !== undefined) {
      requestContext.setQueryParam(
        'player',
        ObjectSerializer.serialize(player, 'string', ''),
      )
    }
    ...
    if (address !== undefined) {
      requestContext.setQueryParam(
        'address',
        ObjectSerializer.serialize(address, 'string', ''),
      )
    }
  ...
  public async getAccountsV2(
    ...
    if (user !== undefined) {
      requestContext.setQueryParam(
        'user',
        ObjectSerializer.serialize(user, 'string', ''),
      )
    }
    ...
    if (chainType !== undefined) {
      requestContext.setQueryParam(
        'chainType',
        ObjectSerializer.serialize(chainType, 'string', ''),
      )
    }
    ...
    if (accountType !== undefined) {
      requestContext.setQueryParam(
        'accountType',
        ObjectSerializer.serialize(accountType, 'string', ''),
      )
    }
   ...
   * @param address
   */
  public async getSignerIdByAddress(
    address: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    const _config = _options || this.configuration
  ...
  public async requestTransferOwnership(
    ...
    if (
      transferOwnershipRequest === null ||
      transferOwnershipRequest === undefined
    ) {
      throw new RequiredError(
        'AccountsApi',
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}/request_transfer_ownership'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
  ...
  public async signPayload(
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}/sign_payload'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
  ...
  public async startRecovery(
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}/start_recovery'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
  ...
  public async syncAccount(
    ...
    // Path Params
    const localVarPath = '/v1/accounts/{id}/sync'.replace(
      '{' + 'id' + '}',
      encodeURIComponent(String(id)),
    )
...
export class AccountsApiResponseProcessor {
  ...
  public async getAccountsV2(
    ...
    if (isCodeInRange('200', response.httpStatusCode)) {
      const body: BaseEntityListResponseAccountV2Response =
