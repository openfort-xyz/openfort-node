...
export class PromiseAccountsApi {
  ...
  public cancelTransferOwnership(
    ...
    const result = this.api.cancelTransferOwnership(
      id,
  ...
  public completeRecovery(
    ...
    const result = this.api.completeRecovery(
      id,
  ...
  public getAccounts(
    ...
    const result = this.api.getAccounts(
      limit,
      skip,
      order,
      chainId,
  ...
  public getAccountsV2(
    ...
    const result = this.api.getAccountsV2(
      limit,
      skip,
      order,
      chainId,
  ...
  public requestTransferOwnership(
    ...
    const result = this.api.requestTransferOwnership(
      id,
...
export class PromiseAdminAuthenticationApi {
  ...
  public getAuthPlayers(
    ...
    const result = this.api.getAuthPlayers(
      limit,
      skip,
      order,
      email,
...
export class PromiseAuthenticationApi {
  ...
  public linkThirdParty(
    ...
    const result = this.api.linkThirdParty(
  ...
  public requestEmailVerification(
    ...
    const result = this.api.requestEmailVerification(
  ...
  public requestResetPassword(
    ...
    const result = this.api.requestResetPassword(
...
export class PromiseContractsApi {
  ...
  public getContracts(
    ...
    const result = this.api.getContracts(
      limit,
      skip,
      order,
      name,
  ...
  public readContract(
    ...
    const result = this.api.readContract(
      id,
      functionName,
      functionArgs,
      _options,
...
export class PromiseEventsApi {
  ...
  public getEvents(
    ...
    const result = this.api.getEvents(
      limit,
      skip,
      order,
      name,
...
export class PromiseForwarderContractApi {
  ...
  public createForwarderContract(
    ...
    const result = this.api.createForwarderContract(
  ...
  public updateForwarderContract(
    ...
    const result = this.api.updateForwarderContract(
      id,
      createForwarderContractRequest,
      _options,
    )
...
export class PromiseInventoriesApi {
  ...
  public getAccountCryptoCurrencyInventory(
    ...
    const result = this.api.getAccountCryptoCurrencyInventory(
      id,
      limit,
      skip,
      order,
  ...
  public getAccountNftInventory(
    ...
    const result = this.api.getAccountNftInventory(
      id,
      limit,
      skip,
      order,
  ...
  public getPlayerCryptoCurrencyInventory(
    ...
    const result = this.api.getPlayerCryptoCurrencyInventory(
      id,
      chainId,
      limit,
      skip,
  ...
  public getPlayerNftInventory(
    ...
    const result = this.api.getPlayerNftInventory(
      id,
      chainId,
      limit,
      skip,
...
export class PromisePaymasterApi {
  ...
  public updatePaymaster(
    ...
    const result = this.api.updatePaymaster(
      id,
...
export class PromisePlayersApi {
  ...
  public cancelTransferAccountOwnership(
    ...
    const result = this.api.cancelTransferAccountOwnership(
      id,
  ...
  public requestTransferAccountOwnership(
    ...
    const result = this.api.requestTransferAccountOwnership(
      id,
...
export class PromisePoliciesApi {
  ...
  public createPolicyWithdrawal(
    ...
    const result = this.api.createPolicyWithdrawal(
      id,
  ...
  public getPolicies(
    ...
    const result = this.api.getPolicies(
      limit,
      skip,
      order,
      expand,
  ...
  public getPolicyReportTransactionIntents(
    ...
    const result = this.api.getPolicyReportTransactionIntents(
      id,
      to,
      _from,
      _options,
  ...
  public getPolicyTotalGasUsage(
    ...
    const result = this.api.getPolicyTotalGasUsage(
      id,
      limit,
      skip,
      order,
...
export class PromisePolicyRulesApi {
  ...
  public getPolicyRules(
    ...
    const result = this.api.getPolicyRules(
      policy,
      limit,
      skip,
      order,
  ...
  public updatePolicyRule(
    ...
    const result = this.api.updatePolicyRule(
      id,
...
export class PromiseSessionsApi {
  ...
  public createSession(
    ...
    const result = this.api.createSession(
  ...
  public getPlayerSessions(
    ...
    const result = this.api.getPlayerSessions(
      player,
      limit,
      skip,
      order,
  ...
  public revokeSession(
    ...
    const result = this.api.revokeSession(
...
export class PromiseSettingsApi {
  ...
  public getDeveloperAccounts(
    ...
    const result = this.api.getDeveloperAccounts(
      limit,
      skip,
      order,
      expand,
  ...
  public signPayloadDeveloperAccount(
    ...
    const result = this.api.signPayloadDeveloperAccount(
      id,
      signPayloadRequest,
      _options,
    )
  ...
  public updateDeveloperAccount(
    ...
    const result = this.api.updateDeveloperAccount(
      id,
...
export class PromiseSubscriptionsApi {
  ...
  public createSubscription(
    ...
    const result = this.api.createSubscription(
  ...
  public listSubscriptionLogs(
    ...
    const result = this.api.listSubscriptionLogs(
      limit,
      skip,
      order,
      topic,
...
export class PromiseTransactionIntentsApi {
  ...
  public createTransactionIntent(
    ...
    const result = this.api.createTransactionIntent(
  ...
  public estimateTransactionIntentCost(
    ...
    const result = this.api.estimateTransactionIntentCost(
      createTransactionIntentRequest,
      _options,
    )
    return result.toPromise()
  ...
  public getTransactionIntents(
    ...
    const result = this.api.getTransactionIntents(
      limit,
      skip,
      order,
      expand,
