...
export class TransactionIntentsApi {
  ...
  public setApiKey(key: TransactionIntentsApiApiKeys, value: string) {
    (this.authentications as any)[TransactionIntentsApiApiKeys[key]].apiKey =
      value;
  }
  ...
  public async createTransactionIntent(
    ...
    if (player === null || player === undefined) {
      throw new Error(
        "Required parameter player was null or undefined when calling createTransactionIntent."
      );
    }
    ...
    if (chainId === null || chainId === undefined) {
      throw new Error(
        "Required parameter chainId was null or undefined when calling createTransactionIntent."
      );
    }
    ...
    if (optimistic === null || optimistic === undefined) {
      throw new Error(
        "Required parameter optimistic was null or undefined when calling createTransactionIntent."
      );
    }
    ...
    if (interactions === null || interactions === undefined) {
      throw new Error(
        "Required parameter interactions was null or undefined when calling createTransactionIntent."
      );
    }
    ...
    if (optimistic !== undefined) {
      localVarFormParams["optimistic"] = ObjectSerializer.serialize(
        optimistic,
        "boolean"
      );
    }
    ...
    if (interactions !== undefined) {
      localVarFormParams["interactions"] = ObjectSerializer.serialize(
        interactions,
        "Array<Interaction>"
      );
    }
  ...
  public async getTransactionIntent(
    ...
    const localVarPath =
      this.basePath +
      "/v1/transaction_intents/{id}".replace(
        "{" + "id" + "}",
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling getTransactionIntent."
      );
    }
  ...
  public async signature(
    ...
    if (signature === null || signature === undefined) {
      throw new Error(
        "Required parameter signature was null or undefined when calling signature."
      );
    }
   ...
   * @param project
   */
  public async updateTransactionIntentResponse(
    id: string,
    project?: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{
    ...
    const localVarPath =
      this.basePath +
      "/v1/transaction_intents/{id}/update_response".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling updateTransactionIntentResponse."
      );
    }
   ...
   * @param project
   */
  public async updateTransactionIntentsResponse(
    project?: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{
    response: http.IncomingMessage;
    ...
    const localVarPath =
      this.basePath + "/v1/transaction_intents/update_response";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders
