...
export class TransactionIntentsApi {
     ...
     * @param project
     */
    public async createTransactionIntent (player: string, chainId: number, optimistic: boolean, interactions: Array<Interaction>, policy?: string, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionIntentResponse;  }> {
     ...
     * @param take
     */
    public async getTransactionIntents (project?: string, filter?: string, order?: string, skip?: number, take?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionIntentsResponse;  }> {
        const localVarPath = this.basePath + '/v1/transaction_intents';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
