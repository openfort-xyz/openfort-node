...
export class ProjectsApi {
     ...
     * @param project
     */
    public async createProject (name: string, livemode?: boolean, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProjectResponse;  }> {
     ...
     * @param project
     */
    public async updateProject (id: string, name: string, livemode?: boolean, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProjectResponse;  }> {
        const localVarPath = this.basePath + '/v1/projects/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
