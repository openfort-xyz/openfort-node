...
export class ProjectsApi {
  ...
  public async createProject(
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling createProject."
      );
    }
    ...
    if (livemode !== undefined) {
      localVarFormParams["livemode"] = ObjectSerializer.serialize(
        livemode,
        "boolean"
      );
    }
  ...
  public async get(
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: GetProjectResponse }> {
  ...
  public async getProjects(
    project?: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: ProjectsResponse }> {
    const localVarPath = this.basePath + "/v1/projects";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
  ...
  public async updateProject(
    ...
    if (name === null || name === undefined) {
      throw new Error(
        "Required parameter name was null or undefined when calling updateProject."
      );
    }
