...
export class ContractsApi {
     ...
     * @param project
     */
    public async createContract (name: string, chainId: number, address?: string, abi?: ContractResponseAbi, publicVerification?: boolean, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContractResponse;  }> {
        ...
        if (abi !== undefined) {
            localVarFormParams['abi'] = ObjectSerializer.serialize(abi, "ContractResponseAbi");
        }
     ...
     * @param project Specifies the unique project ID.
     */
    public async getContracts (project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContractsResponse;  }> {
        const localVarPath = this.basePath + '/v1/contracts';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
