...
export class PoliciesApi {
     ...
     * @param project
     */
    public async createPolicy (name: string, chainId: number, strategy?: Strategy, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PolicyResponse;  }> {
        ...
        if (strategy !== undefined) {
            localVarFormParams['strategy'] = ObjectSerializer.serialize(strategy, "Strategy");
        }
     ...
     * @param project
     */
    public async createPolicyAllowFunction (policy: string, type: string, functionName: string, contract: string, policy2?: string, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AllowFunctionResponse;  }> {
        const localVarPath = this.basePath + '/v1/policies/{policy}/allow_functions'
        ...
        if (policy2 !== undefined) {
            localVarFormParams['policy'] = ObjectSerializer.serialize(policy2, "string");
        }
     ...
     * @param project
     */
    public async getPolicies (project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PoliciesResponse;  }> {
        const localVarPath = this.basePath + '/v1/policies';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param project
     */
    public async getPolicy (id: string, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PolicyResponse;  }> {
     ...
     * @param project
     */
    public async getPolicyAllowFunctions (policy: string, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AllowFunctionsResponse;  }> {
        const localVarPath = this.basePath + '/v1/policies/{policy}/allow_functions'
            .replace('{' + 'policy' + '}', encodeURIComponent(String(policy)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param to
     */
    public async getPolicyDailyGasUsage (policy: string, from?: string, to?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Gas;  }> {
        const localVarPath = this.basePath + '/v1/policies/{policy}/daily_gas_usage'
            .replace('{' + 'policy' + '}', encodeURIComponent(String(policy)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param to
     */
    public async getPolicyTotalGasUsage (policy: string, from?: string, to?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SumGas;  }> {
        const localVarPath = this.basePath + '/v1/policies/{policy}/gas_usage'
            .replace('{' + 'policy' + '}', encodeURIComponent(String(policy)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param project
     */
    public async updatePolicy (id: string, name?: string, chainId?: number, strategy?: Strategy, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PolicyResponse;  }> {
        const localVarPath = this.basePath + '/v1/policies/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param contract
     */
    public async updatePolicyAllowFunction (policy: string, id: string, type?: string, functionName?: string, policy2?: string, project?: string, contract?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AllowFunctionResponse;  }> {
        const localVarPath = this.basePath + '/v1/policies/{policy}/allow_functions/{id}'
            .replace('{' + 'policy' + '}', encodeURIComponent(String(policy)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
