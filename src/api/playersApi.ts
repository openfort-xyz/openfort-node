...
export class PlayersApi {
     ...
     */
    public async createPlayerAccount (player: string, player2: string, project?: string, chainId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountResponse;  }> {
        const localVarPath = this.basePath + '/v1/players/{player}/accounts'
        ...
        if (player2 === null || player2 === undefined) {
            throw new Error('Required parameter player2 was null or undefined when calling createPlayerAccount.');
        }
        ...
        if (player2 !== undefined) {
            localVarFormParams['player'] = ObjectSerializer.serialize(player2, "string");
        }
     ...
     * @param policy
     */
    public async createSession (player: string, publicKey: string, policy?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v1/players/{player}/session'
            .replace('{' + 'player' + '}', encodeURIComponent(String(player)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        if (publicKey === null || publicKey === undefined) {
            throw new Error('Required parameter publicKey was null or undefined when calling createSession.');
        }
        ...
        if (publicKey !== undefined) {
            localVarFormParams['public_key'] = ObjectSerializer.serialize(publicKey, "string");
        }
     ...
     */
    public async getPlayer (id: string, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PlayerResponse;  }> {
     ...
     * @param project Specifies the unique project ID.
     */
    public async getPlayerAccounts (player: string, project?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountsResponse;  }> {
        const localVarPath = this.basePath + '/v1/players/{player}/accounts'
            .replace('{' + 'player' + '}', encodeURIComponent(String(player)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param take
     */
    public async getPlayers (project?: string, filter?: string, order?: string, skip?: number, take?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PlayersResponse;  }> {
        const localVarPath = this.basePath + '/v1/players';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     * @param password
     */
    public async login (email: string, password: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AuthResponse;  }> {
        const localVarPath = this.basePath + '/v1/players/login';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     * @param password
     */
    public async signup (email: string, password: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AuthResponse;  }> {
        const localVarPath = this.basePath + '/v1/players/signup';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
