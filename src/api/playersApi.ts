...
export class PlayersApi {
  ...
  public async createPlayerAccount(
    ...
    if (chainId === null || chainId === undefined) {
      throw new Error(
        "Required parameter chainId was null or undefined when calling createPlayerAccount."
      );
    }
  ...
  public async getPlayer(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling getPlayer."
      );
    }
  ...
  public async getPlayerInventory(
    ...
    const localVarPath =
      this.basePath +
      "/v1/players/{id}/inventory".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling getPlayerInventory."
      );
    }
    ...
    if (chainId === null || chainId === undefined) {
      throw new Error(
        "Required parameter chainId was null or undefined when calling getPlayerInventory."
      );
    }

    if (chainId !== undefined) {
      localVarQueryParameters["chain_id"] = ObjectSerializer.serialize(
        chainId,
        "number"
      );
    }
