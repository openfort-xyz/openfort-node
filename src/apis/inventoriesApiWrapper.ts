...
export class InventoriesApiWrapper extends BaseApiWrapper<InventoriesApi> {
  ...
  public async getPlayerNftInventory(
    req: PlayerInventoryListQueries,
  ...
  public async getAccountNftInventory(
    req: AccountInventoryListQueries,
  ): Promise<InventoryListResponse> {
    return await this.api.getAccountNftInventory(
      req.id,
      req.limit,
      req.skip,
      req.order,
  ...
  public async getAccountNativeInventory(
    req: GetAccountInventoryRequest,
  ): Promise<InventoryResponse> {
